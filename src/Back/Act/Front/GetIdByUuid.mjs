 ...
 *
 * @namespace TeqFw_Web_Auth_Back_Act_Front_GetIdByUuid
 */
// MODULE'S VARS
const NS = 'TeqFw_Web_Auth_Back_Act_Front_GetIdByUuid';
...
export default function (spec) {
     ...
     * @memberOf TeqFw_Web_Auth_Back_Act_Front_GetIdByUuid
     */
