 ...
 */
// MODULE'S VARS
const NS = 'TeqFw_Web_Auth_Front_Dto_Identity';

// MODULE'S CLASSES
/**
 * @memberOf TeqFw_Web_Auth_Front_Dto_Identity
 */
class Dto {
    static namespace = NS;
    /**
 ...
 */
export default class TeqFw_Web_Auth_Front_Dto_Identity {
    ...
    constructor(spec) {
        ...
        // INSTANCE METHODS
        /**
         * @param {TeqFw_Web_Auth_Front_Dto_Identity.Dto} [data]
         * @return {TeqFw_Web_Auth_Front_Dto_Identity.Dto}
         */
